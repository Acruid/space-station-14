...
namespace Mike.Graphics
{
    ...
    internal class VBO
    {
        ...
        public void Buffer<T>(BufferTarget target, T[] buffer, int elementSize, BufferUsageHint hint = BufferUsageHint.StaticDraw)
            where T : struct
        {
            ...
            GL.BufferData(target, new IntPtr(buffer.Length * Marshal.SizeOf(typeof(T))), buffer, hint);
        }
